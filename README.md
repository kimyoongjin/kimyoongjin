...
<br>
**저는 단순한 미적 표현을 넘어, 비즈니스 목표 달성을 위한 핵심 전략 도구를 디자인합니다.** <br>
**시각적 정교함**을 갖춘 결과물을 구현하는 것은 물론, 6개월간의 풀스택 개발 경험을 통해 **기능과 구조를 이해하는 설계자**로서의 역량을 갖추었습니다. 개발팀과의 언어를 이해하고 현실적인 구현 범위를 조율하며, 최종 결과물의 완성도를 극대화하는 **실행력 강한 디자이너**입니다.
<br>
<br>
